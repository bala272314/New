...
class ExcelCellFormatting {
	...
	/**
	 * Function to get the index of the foreground color (i.e., font color) for
	 * the cell
	 * 
	...
	/**
	 * Function to set the index of the foreground color (i.e., font color) for
	 * the cell
	 * 
	 * @param foreColorIndex
	 *            The foreground color (font color) index
	 */
